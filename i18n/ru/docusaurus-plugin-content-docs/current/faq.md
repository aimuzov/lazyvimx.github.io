...
Проверьте [CHANGELOG](https://github.com/aimuzov/LazyVimx/blob/main/CHANGELOG.md) для изменений в конкретных версиях.
...
См. [руководство по началу работы](./getting-started.md). Вкратце:
...
См. [документацию по настройке](./configuration.md) для всех опций.
...
См. [документацию по extras](./extras.md) для всех 48 extras.
...
Да! См. [руководство для контрибьюторов](https://github.com/aimuzov/LazyVimx/blob/main/CONTRIBUTING.md#creating-extras) по созданию кастомных extras.
...
См. [документацию по решению проблем](./troubleshooting.md) для дополнительных решений.
...
- 🤝 [Внесите вклад](https://github.com/aimuzov/LazyVimx/blob/main/CONTRIBUTING.md)
