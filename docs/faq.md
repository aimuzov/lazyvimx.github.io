...
Check the [CHANGELOG](https://github.com/aimuzov/LazyVimx/blob/main/CHANGELOG.md) for version-specific changes.
...
See the [Getting Started](./getting-started.md) guide. Basically:
...
See [extras documentation](./extras.md) for all 48 extras.
...
Yes! See the [contributing guide](https://github.com/aimuzov/LazyVimx/blob/main/CONTRIBUTING.md#creating-extras) for creating custom extras.
...
See [troubleshooting documentation](./troubleshooting.md) for more solutions.
...
- 🤝 [Contribute](https://github.com/aimuzov/LazyVimx/blob/main/CONTRIBUTING.md)
